...
export default class InvitWorkFragment extends FefreshCommonFragment {
    //1.
    constructor(props) {
        super(props);
        this.state = {
    ...
    _init_query_net_data = () => {
        ...
        let paramsObject = {
            ...
            workOrderPushType: 2,//订单发布类型，默认0， 0-自投 1-紧急 2-被聘
    ...
    render() {
        return (
            <View style={InvitWorkFragmentStyles.container}>
                ...
                {this.state.responValue ?
                    <View style={InvitWorkFragmentStyles.function_list}>
                        <FlatList
                            ...
                            contentContainerStyle={InvitWorkFragmentStyles.function_list_contentContainer}
                        />
                    </View>
                    : <View style={[InvitWorkFragmentStyles.function_list, {
                        alignItems: 'center',
                        ...
                        <Text
                            style={InvitWorkFragmentStyles.normal_text}>{this.state.backViewShow}</Text>
                    </View>
                }
            </View>
        );
...
InvitWorkFragmentStyles = StyleSheet.create({
    //基于flex-box布局
    container: {
        width: width,
        flex: 1,
