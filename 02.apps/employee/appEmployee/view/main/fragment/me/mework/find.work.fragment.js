...
export default class FindWorkFragment extends FefreshCommonFragment {
    //1.
    constructor(props) {
        super(props);
        this.state = {
    ...
    _init_query_net_data = () => {
        ...
        let paramsObject = {
            ...
            workOrderPushType: 0,//订单发布类型，默认0， 0-自投 1-紧急 2-被聘
    ...
    render() {
        return (
            <View style={FindWorkFragmentStyles.container}>
                ...
                {this.state.responValue ?
                    <View style={FindWorkFragmentStyles.function_list}>
                        <FlatList
                            ...
                            contentContainerStyle={FindWorkFragmentStyles.function_list_contentContainer}
                        />
                    </View>
                    : <View style={[FindWorkFragmentStyles.function_list, {
                        alignItems: 'center',
                        ...
                        <Text
                            style={FindWorkFragmentStyles.normal_text}>{this.state.backViewShow}</Text>
                    </View>
                }
            </View>
        );
...
FindWorkFragmentStyles = StyleSheet.create({
    //基于flex-box布局
    container: {
        width: width,
        flex: 1,
