...
export default class Calendar extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            isScrolling: false,
            selectedDate: this.parseSelectedDate(this.props.selectedDate),
        };
        ...
        return (
            <View style={styles.root}>
                ...
                <FlatList
                    ...
                    data={this.months}
                    renderItem={({item, index}) => this._getComponent(item, index)}
                    // ItemComponent={this._getComponent}
                    getItemLayout={(item,index)=>this.getItemLayout(item,index)}
