...
export default class RnaSelfsFragment extends PureComponent {
    //1.
    constructor(props) {
        super(props);
        this.state = {
    ...
    componentWillMount() {
        ...
        if (this.props.mobileUserData && this.props.mobileUserData.data && this.props.mobileUserData.data.callPhone) {
            this.setState({
                userCallPhoneNo: this.props.mobileUserData.data.callPhone,
            });
        }
    ...
    _uploadRnaOrder = () => {
        ...
        if(!PatterCommonUtil.isIdCard(this.state.userIdCardNo)){
    ...
    render() {
        return (
            <ScrollView style={RnaSelfsFragmentStyles.function_list}
                        keyboardShouldPersistTaps={'always'}
                        contentContainerStyle={RnaSelfsFragmentStyles.function_list_contentContainer}
            >
                <View style={RnaSelfsFragmentStyles.function_list_container}>
                    ...
                    <RnaEditActivityImageItem leftItemShow={'请拍摄身份证正面'}
                                              ...
                                              onLeftPress={() => this._onLeftPress('上传身份证正面照', 0)}
                                              showRight={true}
                                              rightItemShow={'示例'}
                    ...
                    <RnaEditActivityImageItem leftItemShow={'请拍摄身份证反面'}
                                              ...
                                              onLeftPress={() => this._onLeftPress('上传身份证反面照', 1)}
                                              showRight={true}
                                              rightItemShow={'示例'}
                                              rightShowColor={'#FC333D'}
...
RnaSelfsFragmentStyles = StyleSheet.create({
