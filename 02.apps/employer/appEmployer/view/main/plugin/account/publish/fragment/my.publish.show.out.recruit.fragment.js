...
import AdminFragmentShowManage from '../../../admin/fragment/show/admin.fragment.show.manage'

export default class MyPublishShowOutRecruitFragment extends PureComponent {
    //1.
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        return (
            this.state.responValue ?
                <View style={MyPublishShowOutRecruitFragmentStyles.function_list}>
                    <FlatList
                        ...
                        contentContainerStyle={MyPublishShowOutRecruitFragmentStyles.function_list_contentContainer}
                    />
                </View>
                :
                <View style={[MyPublishShowOutRecruitFragmentStyles.function_list, {
                    ...
                    <Text
                        style={MyPublishShowOutRecruitFragmentStyles.normal_text}>{this.state.backViewShow}</Text>
                </View>
        );
    };
}
...
MyPublishShowOutRecruitFragmentStyles = StyleSheet.create({
    function_list: {
        flex: 1,
