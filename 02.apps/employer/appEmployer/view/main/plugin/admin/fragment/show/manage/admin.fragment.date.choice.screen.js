...
export default class AdminFragmentDateChoiceScreen extends Component {
    ...
    render() {
        return (
            <View style={AdminFragmentDateChoiceScreenStyles.container}>
                <View style={{
                    flexDirection: 'row',
                    padding: 9.6,
                }}>
                    <View style={{flex: 1, flexDirection: 'row',}}>
                        <Text style={[AdminFragmentDateChoiceScreenStyles.normal_text, {
                            fontSize: 12,
                        }]}>还未打卡</Text>
                        <View style={[AdminFragmentDateChoiceScreenStyles.view_line, {
                ...
                <View style={AdminFragmentDateChoiceScreenStyles.cut_line}/>
                {this.state.showDates ?
                    <Calendar
                        style={AdminFragmentDateChoiceScreenStyles.calendar}
...
const AdminFragmentDateChoiceScreenStyles = StyleSheet.create({
    container: {
        flex: 1,
