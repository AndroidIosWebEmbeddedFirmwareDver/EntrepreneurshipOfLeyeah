...
export default class AdminHadDoFragment extends PureComponent {
    //1.
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        return (
            this.state.responValue ?
                <View style={AdminHadDoFragmentStyles.function_list}>
                    <FlatList
                        ...
                        contentContainerStyle={AdminHadDoFragmentStyles.function_list_contentContainer}
                    />
                </View>
                :
                <View style={[AdminHadDoFragmentStyles.function_list, {
                    ...
                    <Text
                        style={AdminHadDoFragmentStyles.normal_text}>{this.state.backViewShow}</Text>
                </View>
        );
    };
}
...
AdminHadDoFragmentStyles = StyleSheet.create({
    function_list: {
        flex: 1,
