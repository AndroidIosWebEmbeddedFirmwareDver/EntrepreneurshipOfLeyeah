...
export default class AdminDoneDoFragment extends PureComponent {
    //1.
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        return (
            this.state.responValue ?
                <View style={AdminDoneDoFragmentStyles.function_list}>
                    <FlatList
                        ...
                        contentContainerStyle={AdminDoneDoFragmentStyles.function_list_contentContainer}
                    />
                </View>
                :
                <View style={[AdminDoneDoFragmentStyles.function_list, {
                    ...
                    <Text
                        style={AdminDoneDoFragmentStyles.normal_text}>{this.state.backViewShow}</Text>
                </View>
        );
    };
}
...
AdminDoneDoFragmentStyles = StyleSheet.create({
    function_list: {
        flex: 1,
