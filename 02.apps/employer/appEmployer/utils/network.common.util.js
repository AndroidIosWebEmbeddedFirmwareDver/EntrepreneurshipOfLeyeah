...
export default class NetworkCommonUtil {
    ...
    // static SERVERURL = 'http://47.90.72.19:8808/leyeah'; // 公网测试服服务端URL
    static SERVERURL = 'http://120.78.189.94:8808/leyeah'; // 公网正式服服务端URL
    ...
    static SERVERURL_SYS_USER_EMPLOYER_UPDATE_IDCARDNO = NetworkCommonUtil.SERVERURL + '/api/mobile/user/employer/update/idcardNo';
    static SERVERURL_SYS_USER_EMPLOYER_UPDATE_CALLPHONE = NetworkCommonUtil.SERVERURL + '/api/mobile/user/employer/update/callPhone';
    ...
    //雇主创建新订单，并对指定雇员发起邀请
    static SERVERURL_API_MOBILE_ORDER_EMPLOY_EMPLOYER_SEND_INVITS_BY_CREATE_NEW_ORDER = NetworkCommonUtil.SERVERURL + '/api/mobile/order/employ/employer/send/invit/by/create/new/order';
    ...
    //按照工作类型分页查找满足条件的雇员
    static SERVERURL_POST_ORDER_EMPLOY_EMPLOYER_FIND_EMPLOYEE = NetworkCommonUtil.SERVERURL + '/api/mobile/order/employ/employer/find/employees/by/worktype/and/workexp/forpages';


    //按照工作类型查找满足条件的属于指定雇主的工作订单
    static SERVERURL_POST_ORDER_EMPLOY_EMPLOYER_FIND_NOT_START_WORK_BY_WORK_TYPE = NetworkCommonUtil.SERVERURL + '/api/mobile/order/employ/employer/find/not/start/work/by/worktype';

    //雇主对雇员发起工作邀请，已经创建的工作
    static SERVERURL_POST_ORDER_EMPLOY_EMPLOYER_SEND_INVIT_TO_EMPLOYEES_FOR_ME_ORDER = NetworkCommonUtil.SERVERURL + '/api/mobile/order/employ/employer/send/invit/for/me/order';

    //雇主查询满足发布类型条件的工作
    static SERVERURL_POST_ORDER_EMPLOY_EMPLOYER_QUERY_ME_ORDERS_BY_PUSH_TYPE = NetworkCommonUtil.SERVERURL + '/api/mobile/order/employ/employer/query/me/order/by/push/type';


    //雇主查询满足订单状态条件的工作
    static SERVERURL_POST_ORDER_EMPLOY_EMPLOYER_QUERY_ME_ORDERS_BY_ORDER_STATUS = NetworkCommonUtil.SERVERURL + '/api/mobile/order/employ/employer/query/me/order/by/work/status';
    //雇主查询满足订单发布、招聘状态条件的工作
    static SERVERURL_POST_ORDER_EMPLOY_EMPLOYER_QUERY_ME_ORDERS_BY_RECRUIT_AND_PUBLISH_STATUS = NetworkCommonUtil.SERVERURL + '/api/mobile/order/employ/employer/query/me/order/by/recruit/status/and/push/type';


    //雇主查询工作详情
    static SERVERURL_POST_ORDER_EMPLOY_EMPLOYER_QUERY_ME_ORDER_DETIAL_BY_ORDER = NetworkCommonUtil.SERVERURL + '/api/mobile/order/employ/employer/query/me/order/detial/by/order';

    //雇主查询订单中的雇员信息
    static SERVERURL_POST_ORDER_EMPLOY_EMPLOYER_QUERY_ME_ORDER_EMPLOYEES = NetworkCommonUtil.SERVERURL + '/api/mobile/order/employ/employer/query/oder/employees';
    static SERVERURL_POST_ORDER_EMPLOY_EMPLOYER_QUERY_ME_ORDER_EMPLOYEES_WITH_EMPLOY_DETIALS = NetworkCommonUtil.SERVERURL + '/api/mobile/order/employ/employer/query/oder/employees/with/employ/detials';

    //雇主逻辑删除订单
    static SERVERURL_POST_ORDER_EMPLOY_EMPLOYER_DELETE_ORDER = NetworkCommonUtil.SERVERURL + '/api/mobile/order/employ/employer//delete/order/for/me/by/order/id';

    //雇主修改订单开工状态
    static SERVERURL_POST_ORDER_EMPLOY_EMPLOYER_UPDATE_ORDER_STATUS = NetworkCommonUtil.SERVERURL + '/api/mobile/order/employ/employer/update/order/status';

    //雇主修改订单招聘状态
    static SERVERURL_POST_ORDER_EMPLOY_EMPLOYER_UPDATE_ORDER_RECRUIT_STATUS = NetworkCommonUtil.SERVERURL + '/api/mobile/order/employ/employer/update/work/recruit/status/order/for/me';


    //修改----------------
    //修改雇主录用状态
    static SERVERURL_POST_ORDER_FOR_EMPLOYEE_CHANGE_EMPLOYER_WORK_CONFIRM_STATUS = NetworkCommonUtil.SERVERURL + '/api/mobile/order/for/emplpyer/changeEmployerWorkConfirmStatus';
    //修改雇主付款状态
    static SERVERURL_POST_ORDER_FOR_EMPLOYEE_CHANGE_EMPLOYER_WORK_PAIED_STATUS = NetworkCommonUtil.SERVERURL + '/api/mobile/order/for/emplpyer/changeEmployerPaidedWorkStatus';
    //修改雇员下工状态
    ...
    //账单
    //雇主查询账单
    static SERVERURL_POST_ORDER_EMPLOY_EMPLPYER_BILLS_FIND_BILLS = NetworkCommonUtil.SERVERURL + '/api/mobile/order/employ/employer/bills/find/bills';
    //雇主修改账单支付状态
    static SERVERURL_POST_ORDER_EMPLOY_EMPLPYER_BILLS_CONFITM_BILL_PAID_STATUS = NetworkCommonUtil.SERVERURL + '/api/mobile/order/employ/employer/bills/confirm/bill/paied/status';
    ...
    //通知
    static SERVERURL_POST_API_MOBILE_NOTI_FOR_EMPLOYER_FIND_ALL_OF_ME = NetworkCommonUtil.SERVERURL + '/api/mobile/noti/for/employer/find/all/of/me';
